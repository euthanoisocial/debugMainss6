...
{
	//pDrawMessage("CCapeAnimation::DrawViewPort called", 1); // Thông báo debug
...
//tue add Hon hoan //
#if SPK_HONHOAN
	//MsgBox("AddHonHoanCape called"); // Thông báo debug
	gHonHoan.AddHonHoanCape(ObjectPointer);
	if (gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh > 0 && gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh < 57)
	{
		vec3_t Color;
		Vector(1.0, 1.0, 1.0, Color);
		if (gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh >= 6) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan + 5, 2.3f, 2.3f, Color, 1);
		if (gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh >= 5) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan + 4, 1.9f, 1.9f, Color);
		if (gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh >= 4) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan + 3, 1.6f, 1.6f, Color, 1);
		if (gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh >= 3) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan + 2, 1.3f, 1.3f, Color);
		if (gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh >= 2) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan + 1, 1.0f, 1.0f, Color, 1);
		if (gCustomRankUser.m_Data[Object->aIndex].m_rNguHanh >= 1) gObjUser.CBRenderCharacter(ObjectPointer, eImgHonHoan, 0.8f, 0.8f, Color);
