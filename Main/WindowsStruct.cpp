...
void PetMuunHP(signed int x, signed int y, int nameIndex, signed int hp, signed int hpmax, char a9)
{
	...
	if( MinimizarPet == 0 )
	{
		RenderBitmap(61545, 570, y + 12, Return2X(TransForX( 74 )), ReturnY(TransForY( 24 )), 0.0, 0.1731800437, 0.75, 0.2378999293,1, 1, 0); //-- Fondo // thanh mau den
		
		pSetTextColor(pTextThis(), 0xFFu, 0xFFu, 0xFFu, 0xFFu);
		pSetBackgroundTextColor(pTextThis(), 0, 0, 0, 0);
		pDrawText(pTextThis(), 575, y + 17, (LPCTSTR)nameIndex, 0, 0, (LPINT)1, 0);//ten pet
		...
		pDrawBarForm(574, y + 28, Return2X(TransForX( v15 )), ReturnY(TransForY( 4 )), 0, 0);
		pGLSwitch();
		pSetBlend(0);
...
//=============================
	...
	*(DWORD *)(This + 280) = 51522;
	//-- Pentagrama
	/*g_pNewMyInventory.SetEquipmentSlotInfo(EQUIPMENT_PET_1, 891554, Return2X(x + TransForX(50)), ReturnY(TransForY(128)), Return2X(TransForX(29)), 28);
	g_pNewMyInventory.SetEquipmentSlotInfo(EQUIPMENT_ERRING_RIGHT, 891553, Return2X(x + TransForX(50)), ReturnY(TransForY(99)), Return2X(TransForX(29)), 28);
	g_pNewMyInventory.SetEquipmentSlotInfo(EQUIPMENT_ERRING_LEFT, 891553, Return2X(x + TransForX(112)), ReturnY(TransForY(99)), Return2X(TransForX(29)), 28);*/

				if(gHuyHieuCuongHoa.huyhieu >=1)
			{
				pDrawGUI(59990, Return2X(x + TransForX(112)), ReturnY(TransForY(128)), Return2X(TransForX(27)), 23);
			}
			else
			{
				pDrawGUI(59999, Return2X(x + TransForX(112)), ReturnY(TransForY(128)), Return2X(TransForX(27)), 23);
			}
		float Solarx;
		...
		if(gInterface.CheckWindow(Inventory) && pCheckMouseOver(Return2X(x + TransForX(112)), ReturnY(TransForY(128)), Return2X(TransForX(24)), 22))
		{
			gCentral.PrintDropBox(Solarx + 80, StartY, MainWidth - 80, MainHeight, 0, 0);

		CustomFont.Draw(CustomFont.FontBold, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) - 60, 0xFFBF00FF, 0x0, 210, 0, 3, gOther.TextVN_NhiemVu[15]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) - 45, 210, 3, gOther.TextVN_NhiemVu[16]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) - 35, 210, 3, gOther.TextVN_NhiemVu[17]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) - 25, 210, 3, gOther.TextVN_NhiemVu[18]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) - 15, 210, 3, gOther.TextVN_NhiemVu[19]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) - 5, 210, 3, gOther.TextVN_NhiemVu[20]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 5, 210, 3, gOther.TextVN_NhiemVu[21]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 15, 210, 3, gOther.TextVN_NhiemVu[22]);
		gInterface.DrawFormat(eYellow, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 25, 210, 3, gOther.TextVN_NhiemVu[23]);
	
		pSetTextColor(pTextThis(), 255, 255, 255, 0xFFu); //-- ewhite
		pDrawText(pTextThis(), Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 40, gOther.TextVN_NhiemVu[24], 200, 0, (LPINT) 3, 0);

		if(gHuyHieuCuongHoa.huyhieu >=1)
		{
			gInterface.DrawFormat(eExcellent, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 50, 210, 3, gOther.TextVN_NhiemVu[25], gHuyHieuCuongHoa.dong1);
		} 
		else
		{
			gInterface.DrawFormat(eGray100, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 50, 210, 3, gOther.TextVN_NhiemVu[25], gHuyHieuCuongHoa.dong1);
		}
		if(gHuyHieuCuongHoa.huyhieu >=2)
		{
			gInterface.DrawFormat(eExcellent, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 60, 210, 3, gOther.TextVN_NhiemVu[26], gHuyHieuCuongHoa.dong2);
		} 
		else
		{
			gInterface.DrawFormat(eGray100, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 60, 210, 3, gOther.TextVN_NhiemVu[26], gHuyHieuCuongHoa.dong2);
		}

		if(gHuyHieuCuongHoa.huyhieu >=3)
		{
			gInterface.DrawFormat(eExcellent, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 70, 210, 3, gOther.TextVN_NhiemVu[27], gHuyHieuCuongHoa.dong3);
		}
		else
		{
			gInterface.DrawFormat(eGray100, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 70, 210, 3, gOther.TextVN_NhiemVu[27], gHuyHieuCuongHoa.dong3);
		}
		if(gHuyHieuCuongHoa.huyhieu >=4)
		{
			gInterface.DrawFormat(eExcellent, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 80, 210, 3, gOther.TextVN_NhiemVu[28],gHuyHieuCuongHoa.dong4);	
		}
		else
		{
			gInterface.DrawFormat(eGray100, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 80, 210, 3, gOther.TextVN_NhiemVu[28],gHuyHieuCuongHoa.dong4);	
		}
		if(gHuyHieuCuongHoa.huyhieu >=5)
		{
			gInterface.DrawFormat(eExcellent, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 90, 210, 3, gOther.TextVN_NhiemVu[29],gHuyHieuCuongHoa.dong5);	
		}
		else
		{
			gInterface.DrawFormat(eGray100, Solarx + (MainWidth / 2) - (137 / 2) + 0, TxtStart + (33.0f * TxtCount) + 90, 210, 3, gOther.TextVN_NhiemVu[29],gHuyHieuCuongHoa.dong5);
		}
	}
	...
	*(DWORD *)(MainSlot + 40) = Return2X(x + (Width / 2) - TransFor2X(t / 2));
	...
	//gInterface.DrawXoaHomDoWinDow();
	//gInterface.DrawTinhNangWinDow();
//	gInterface.DrawRingPedanWinDow();
#endif
...
void WindowsInfoWareHouse(int a1)
{
	...
	*(signed int *)(This + 16) = 1;
	...
	{
		int t = ( 8 * 17 ) / 2;
		*(DWORD *)((*(DWORD *)(This + 540)) + 44) = 73; /// chỉnh tọa độ hòm đồ lên xuống 
		*(DWORD *)((*(DWORD *)(This + 540)) + 40) = x + 23; //Return2X(( Width / 2 ) - TransForX( t )); // chỉnh tọa độ hòm đồ trái phải
	}
...
void WindowsInfoWareHouseExt(int a1)
{
	...
	*(signed int *)(This + 16) = Return2X(TransForX( 190 ) );
	...
	if ( *(DWORD *)(v6 + 544) )
	{
		...
		*(DWORD *)((*(DWORD *)(v6 + 544)) + 40) = + 159;//Return2X(x + ( Width / 2 ) - TransForX( t ));
	}
