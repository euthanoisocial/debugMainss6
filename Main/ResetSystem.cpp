...
void ResetSystem::BinObeject()
{
	gInterface.BindObject(OBJECT_RESET_MAIN, 0x7A5A, 222, 303, -1, -1);
	gInterface.BindObject(OBJECT_RESET_TITLE, 0x7A63, 230, 67, -1, -1);
	gInterface.BindObject(OBJECT_RESET_FRAME, 0x7A58, 230, 15, -1, -1);
	gInterface.BindObject(OBJECT_RESET_FOOTER, 0x7A59, 230, 50, -1, -1);
	gInterface.BindObject(OBJECT_RESET_DIV, 0x7A62, 223, 21, -1, -1);
	gInterface.BindObject(OBJECT_RESET_INFO_BG, 0x7AA3, 170, 21, -1, -1);
	gInterface.BindObject(OBJECT_RESET_MONEY_BG, 0x7A89, 170, 26, -1, -1);
	gInterface.BindObject(OBJECT_RESET_CLOSE, 0x7EC5, 36, 29, -1, -1);
	gInterface.BindObject(OBJECT_RESET_FINISH, 0x7A5E, 106, 29, -1, -1);
}
