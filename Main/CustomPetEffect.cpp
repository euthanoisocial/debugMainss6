...
if ( v392 )
{
 ...
 CreateSprite(32002, Bone, 2.0, Color, a1, 0.0, 0);//<<Estatico
// CreateParticle(32394, Bone, a1 + 264, Color, 0.0, 1.0, 1);//<<Dinamico
        int v25 = timeGetTime() % 0x400;      
 if ( v25 >= 0 && v25 < 10 )//<<Cantidad de particulas en Efecto Skill (Se modifica el Numero 10)      
 {
 CreateEffect(176, a1 + 252, a1 + 264, Color, 3, a1, -1, 0, 0, 0, 0.0, -1);//<<Efecto Skill
 }
 }
 break;
 }
