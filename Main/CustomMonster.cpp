...
lpViewObj CCustomMonster::ShowMonster(int MonsterID, int a2, int a3, int a4)
{
	...
	if (MonsterID == 700 || MonsterID == 701 || MonsterID == 702 || MonsterID == 703 || MonsterID == 704 || MonsterID == 705 || MonsterID == 706)
	{
		iModel = 1163;
	}
	...
	switch (lpInfo->Type){
	case 0:
		*(BYTE*)(ObjectStruct + 700) = emNPC;
		break;
	case 1:
		*(BYTE*)(ObjectStruct + 700) = emMonster;
		break;
	default:
		*(BYTE*)(ObjectStruct + 700) = emNone;
		break;
	}
	...
	*(BYTE*)(ObjectStruct + 798) = 0;
	...
	if (MonsterID == 706)
	{
		...
		gPreview->WeaponFirstSlot = ITEM2(0, 110);
		gPreview->WeaponSecondSlot = ITEM2(0, 110);
