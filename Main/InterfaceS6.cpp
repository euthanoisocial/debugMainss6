...
void WideAttributoBP(int ImageID, float PosX, float PosY, float Width, float Height, float Arg6, float Arg7, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, float ScaleAlpha)
{
	...
	RenderBitmap(31299, PosX + JCResto, PosY, Width,  Height,  Arg6,  Arg7,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
}
...
void WideAttributoSD(int ImageID, float PosX, float PosY, float Width, float Height, float Arg6, float Arg7, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, float ScaleAlpha)
{
	...
	RenderBitmap(31300, PosX + JCResto, PosY, Width,  Height,  Arg6,  Arg7,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
}
...
{
	float JCResto = pWinWidth / pWinHeightReal / 2 - 320;
	RenderBitmap(31298, PosX + JCResto, PosY, Width,  Height,  Arg6,  Arg7,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
	/*if(ReHP >= 55000){
...
{
	float JCResto = pWinWidth / pWinHeightReal / 2 - 320;
	RenderBitmap(31297, PosX + JCResto, PosY, Width,  Height,  Arg6,  Arg7,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
	//if(ReHPG >= 55089){
...
{
	float JCResto = pWinWidth / pWinHeightReal / 2 - 320;
	RenderBitmap(31296, PosX + JCResto, PosY, Width,  Height,  Arg6,  Arg7,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
	/*if(ReMP >= 55025){
...
void RenderGUI(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	pDrawGUI(ImageID,  PosX + JCResto, PosY, Width,  Height);
}
...
void InterfaceLeft(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	RenderBitmap(87968, x, PosY, 70.28048780487805, 51, 0.0, 0.0, 0.8785000443, 0.6409999728, 1, 1, 0.0);
...
void InterfaceMiddle(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	ChangeButtonInfo((char *)(v38 + 56), JCResto + 489, 429, 30, 41); //-- cashshop

	ChangeButtonInfo((char *)(v38 + 228), JCResto + 519, 429, 30, 41); //-- character

	ChangeButtonInfo((char *)(v38 + 400), JCResto + 549, 429, 30, 41); //-- inventario

	ChangeButtonInfo((char *)(v38 + 572), JCResto + 579, 429, 30, 41); //-- friend list

	ChangeButtonInfo((char *)(v38 + 744), JCResto + 609, 429, 30, 41); //-- system config
}
...
void InterfaceRight(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	RenderBitmap(87968, PosX + JCResto + Width, PosY, 70.28048780487805, Height, 0.8785000443, 0.0, -0.8785000443, 0.6409999728, 1, 1, 0.0);
}
...
void JCRenderBarExp(int ImageID, float PosX, float PosY, float Width, float Height, float CurrentMoveX, float CurrentMoveY, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, bool ScaleAlpha)
{
	...
	RenderBitmap(ImageID,  PosX + JCResto, PosY, Width,  Height,  CurrentMoveX,  CurrentMoveY,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
}
...
void JCJCRenderBarExpAdd(float PosX, float PosY, float Width, float Height, float Arg5, int Arg6)
{
	...
	pDrawBarForm(PosX + JCResto, PosY, Width, Height, Arg5, Arg6);
}
...
bool JCCheckMouseTooltip(int a1, int a2, int a3, int a4)
{
	...
	return pCheckMouseOver(a1 + JCResto, a2, a3, a4);
}
...
int JCTooltipDraw(int X, int Y, LPCSTR Text)
{
	...
	return pDrawToolTip(X + JCResto, Y, Text);
}
...
void RenderNumber(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumber(a4 + JCResto, a5, Number, a7);
}
...
void RenderButtonQuest(DWORD ModelID, float X, float Y, float W, float H, float CurrentX, float CurrentY)
{
	...
	pDrawButton(ModelID, X + JCResto, Y, W, H, CurrentX, CurrentY);
}
...
__declspec(naked) void RenderSlotQ()
{
	...
	{
		PUSH ECX                                 ; /Arg4
		FLD DWORD PTR DS:[0xD4B304]         ; |
		FSTP DWORD PTR SS:[ESP]                  ; |
		PUSH ECX                                 ; |Arg3
		FLD DWORD PTR DS:[RenderNumberX]         ; |
		FSTP DWORD PTR SS:[ESP]                  ; |
		PUSH ECX                                 ; |Arg2
		FLD DWORD PTR DS:[0xD4B300]         ; |
		FSTP DWORD PTR SS:[ESP]                  ; |
		PUSH ECX                                 ; |Arg1
...
bool JCEventMouseSkill(int a1)
{
	...
	else
	{
		...
		*(BYTE *)(v62 + 65) = 0;
		...
		{
			//-- skill using
			if ( gProtect.m_MainInfo.CustomInterfaceType == JSeason1 
			|| gProtect.m_MainInfo.CustomInterfaceType == JSeason2 )
			{
				v82 = 310.0f + JCResto;
				v87 = 447.05;
				v70 = 20.0;
			...
			else if (gProtect.m_MainInfo.CustomInterfaceType == JEx700 
			|| gProtect.m_MainInfo.CustomInterfaceType == JLegends )
			{
				//-- skill using
				v82 = JCResto + 308.0; //-- x
				v87 = 445.5; //--y
...
void JCSkillSelectBar( int JCMainSelect )
{
	...
	if ( gProtect.m_MainInfo.CustomInterfaceType != JEx700 
		&& gProtect.m_MainInfo.CustomInterfaceType != JLegends )
	{
		...
		if ( (signed int)*(BYTE *)(dword_8128AC8 + 118) > 0 )
		{
			...
			if ( v9 && *(BYTE *)(v9 + 55) != 3 )
			{
				...
				{
					JCLoadSkill(JCMainSelect, *(BYTE *)(dword_7BC4F04 + 50), JCResto + 310.0f, 447.00, 20.0, 28.0);
				}
			}
		}
	}
	else
	{
		if ( (signed int)*(BYTE *)(dword_8128AC8 + 118) > 0 )
		{
			...
			if ( v9 && *(BYTE *)(v9 + 55) != 3 )
			{
				RenderBitmap(51500, JCResto + 306, 443.5f, 20.0f, 24.0f, 0.1600000411f, 0.1000000089f, 0.6397998333f, 0.4179990888f, 1, 1, 0);
				JCSkillScale = 1;
				JCLoadSkill(JCMainSelect, *(BYTE *)(dword_7BC4F04 + 50), JCResto + 308, 445.5f, 20.0, 28.0);
				JCSkillScale = 0;
			}
		}
	}
...
char JCSkillSwitchBar( int JCMainSelect )
{
	...
	if ( (signed int)*(BYTE *)(dword_8128AC8 + 118) > 0 && *(BYTE *)(JCMainSelect + 64) == 1 )
	{
		...
		RenderBitmap(61546, JCResto + 191.3, 350.0, 243.5, 60.0, 0.0, 0.0, 1.0, 1.0, 1, 1, 0);
	...
	SwitchEventSkill(v11, JCResto + 191.0, 349.0);
...
{
	JCRenderNumber(x, y, number, scale);
}
...
void JCExpBarDowngrade(int ImageID, float PosX, float PosY, float Width, float Height, float CurrentMoveX, float CurrentMoveY, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, bool ScaleAlpha)
{
	...
	RenderBitmap(ImageID, 220.0f + Addradd, 434.5f, RenderW, 6.0f, CurrentMoveX, CurrentMoveY, ScaleX, ScaleY, ScaleSize, ScalePosition, ScaleAlpha);
}
...
void JCMoveExpBarDowngrade(int ImageID, float PosX, float PosY, float Width, float Height, float CurrentMoveX, float CurrentMoveY, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, bool ScaleAlpha)
{
	...
	RenderBitmap(ImageID, JCCoordX + Addradd, 434.5f, RenderW, 6.0f, CurrentMoveX, CurrentMoveY, ScaleX, ScaleY, ScaleSize, ScalePosition, ScaleAlpha);
}
...
void JCExpBarDowngradeAdd(float PosX, float PosY, float Width, float Height, float Arg5, int Arg6)
{
	...
	pDrawBarForm(JCCoordX + Addradd, 434.5f, RenderW, 6.0f, Arg5, Arg6);
}
...
bool pCheckExpBarCurrent(int x, int y, int w, int h)
{
	...
	return pCheckMouseOver(220 + Addradd, 435, 198, 6);
}
...
int JCTooltipExpCurrent(int X, int Y, LPCSTR Text)
{
	...
	return pDrawToolTip(220 + Addradd, Y, Text);
}
...
void RenderNumberExp(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumberEx(425 + Addradd, 431.5, Number, a7);
}
...
void JInterfaceLeft(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	pDrawGUI(ImageID, PosX + Addradd, PosY, Width, Height);
	...
	JCRenderNumberEx(22 + Addradd, PosY + 34, pGetUserCoorX, 0.9499999881);

	glColor3f(1.0, 0.89999998, 0.69999999);
	JCRenderNumberEx(46 + Addradd, PosY + 34, pGetUserCoorY, 0.9499999881);
	pGLSwitch();
	glColor3f(1.0, 1.0, 1.0);
	EnableAlphaTest(1);

	RenderBitmap(2336, PosX + Addradd - 20.0, 362.0, 117.0, 75.0, 0.0, 0.0, 0.8999999762, 0.5600000024, 1, 1, 0.0);
}
...
void JInterfaceRight(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	RenderBitmap(87968, PosX + Addradd + Width, PosY, 70.28048780487805, Height, 0.8785000443, 0.0, -0.8785000443, 0.6409999728, 1, 1, 0.0);

	ChangeButtonInfo((char *)(v38 + 228), 379 + Addradd, 449, 25, 25); //-- character
	ChangeButtonInfo((char *)(v38 + 400), 409 + Addradd, 449, 25, 25); //-- Inventory
	ChangeButtonInfo((char *)(v38 + 572), 581 + Addradd, 432, 52, 18); //-- Frient List
	ChangeButtonInfo((char *)(v38 + 744), 5 + Addradd, 432, 52, 18); //-- Menu Fast

	if( pCheckWindow(pWindowThis(), 16) ) //-- char
	{
		pDrawButton(88900, 379 + Addradd, 449, 26, 28, 0, 0);
	}
	if( pCheckWindow(pWindowThis(), 1) ) //-- frient
	{
		pDrawButton(88901, 581 + Addradd, 432, 52, 18, 0, 0);
	}
	if( pCheckWindow(pWindowThis(), 13) ) //-- inv
	{
		pDrawButton(88902, 409 + Addradd, 449, 26, 28, 0, 0);
	}
	if( pCheckWindow(pWindowThis(), 34) ) //-- fast menu
	{
		pDrawButton(88903, 5 + Addradd, 432, 52, 18, 0, 0);
	}
	if( pCheckWindow(pWindowThis(), 3) ) //-- party
	{
		pDrawButton(88904, 348 + Addradd, 449, 26, 28, 0, 0);
	}
	if( pCheckWindow(pWindowThis(), 6) ) //-- Guild
	{
		pDrawButton(88905, 579 + Addradd, PosY + 27, 56, 22, 0, 0);
	}
	...
	if( pCheckMouseOver(581 + Addradd, 454, 52, 18))
	{
		pDrawToolTip(581 + Addradd, 454 - 10, "Guild");
	...
	if ( WinWidth != CGetScreenWidth2( ) || pCheckWindow(pWindowThis( ), SkillTree)
	...
	RenderBitmap(2336, PosX + Addradd + Width - 95.0, 362.0, 117.0, 75.0, 0.8999999762, 0.0, -0.8999999762, 0.5600000024, 1, 1, 0.0);
...
void JPrintAtributoPlayer(int ImageID, float PosX, float PosY, float Width, float Height, float CurrentX, float CurrentY, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, float ScaleAlpha)
{
	...
	if( ImageID == 31296 || ImageID == 31297 || ImageID == 31298 ) //-- Current HP || mp
	{
		...
		if( 31296 == ImageID )
		{
			RenderBitmap(ImageID, 489.0400085 + Addradd, v21, 52.0f, v18, 0.0, v5, 0.823125124, v3, 1, 1, 0.0);
		}
		else
		{
			RenderBitmap(ImageID, 98.0f + Addradd, v21, 52.0f, v18, 0.0, v5, 0.823125124, v3, 1, 1, 0.0);
		}
	}
	else //-- Current AG || SD
	{
		...
		if(ImageID == 31299)
		{
			RenderBitmap(ImageID, 552.0f + Addradd, v21, 13.5f, v18, CurrentX, v5, 0.9319999814f, v3, 1, 1, 0.0);
		}
		else
		{
			if( gProtect.m_MainInfo.CustomInterfaceType == JSeason2 )
			{
				RenderBitmap(ImageID, 73.59999847 + Addradd, v21, 13.5, v18, CurrentX, v5, 0.9319999814, v3, 1, 1, 0.0);
			}
		}
	}
}
...
bool JCheckAtributoPlayer(int a1, int a2, int a3, int a4)
{
	...
	if( a1 == 158 )
	{
		return pCheckMouseOver(98 + Addradd, 429, 52, 52);
	}
	else if( a1 == 437 )
	{
		return pCheckMouseOver(490 + Addradd, 429, 52, 52);
	}
	else if( a1 == 420 )
	{
		return pCheckMouseOver(552 + Addradd, 435, 13, 38);
	}
	else
	{
		if( gProtect.m_MainInfo.CustomInterfaceType == JSeason2 )
		{
			return pCheckMouseOver(73 + Addradd, 435, 13, 38);
		}
		else
		{
			return false;
...
int JInfoAtributoPlayer(int a1, int a2, LPCSTR Text)
{
	...
	if( a1 == 158 )
	{
		return pDrawToolTip(98 + Addradd, 405, Text);
	}
	else if(a1 == 400)
	{
		return pDrawToolTip(535 + Addradd, 405, Text);
	}
	else if( a1 == 437 )
	{
		return pDrawToolTip(488 + Addradd, 405, Text);
	}
	else
	{
		if( gProtect.m_MainInfo.CustomInterfaceType == JSeason1 )
		...
		{
			return pDrawToolTip(46 + Addradd, 405, Text);
		}
	}
}
...
void JInfoAtributoHP(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumberEx(98 + 25.0f + Addradd, 470, Number, a7);
}
...
void JInfoAtributoMP(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumberEx(490 + 30.0f + Addradd, 470, Number, a7);
}
...
void JInfoAtributoAG(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumberEx(552 + 10.0f + Addradd, 470, Number, a7);
}
...
void JInfoAtributoSD(float a4, float a5, int Number, float a7)
{
	...
	if( gProtect.m_MainInfo.CustomInterfaceType == JSeason2 )
	{
		JCRenderNumberEx(73 + 15.0f + Addradd, 470, Number, a7);
	}
}
...
//
//void PetHPBarEx(signed int x, signed int y, int nameIndex, signed int hp, signed int hpmax, char a9)
//{
//	float v15; // ST30_4@4
//	float v16; // ST10_4@4
//	int moveparty;
//
//	//	moveparty = (*(DWORD*)0x81F6B6C > 0) ? 80 : 0;
//
//	
//
//	(MinimizarParty == 1)? (moveparty = (*(DWORD*)0x81F6B6C > 0) ? 80 : 0):moveparty = (GetPartyBar.PartyMemberCount > 0) ? 90 : 0;
//
//
//	/*if( JCProtect.m_MainInfo.TypeHelperBar == 1 )
//	{*/
//		x = CGetScreenWidth2( ) - 63 - moveparty;
//	
//		if( y == 50 )
//		{
//			y = y - 10;
...
//
//	if ( a9 )
//		glColor4f(0.2, 0.0, 0.0, 0.69999999);
//	else
//		glColor4f(0.0, 0.0, 0.0, 0.69999999);
//
//	pDrawBarForm((double)(x + 2), (double)(y + 2), 53.0, 13.0, 0.0, 0);
//	pGLSupremo( );
//	glColor4f(1.0, 1.0, 1.0, 1.0);
//
//	pDrawGUI(31624, x, y, 57.0, 23.0);
//
//	v15 = (double)hp / (double)hpmax * 50.0;
//	pDrawGUI(31625, (double)(x + 4), (double)(y + 16), v15, 3.0);
//
...
//	//else
//	//{
//	//	moveparty = (GetPartyBar.PartyMemberCount > 0) ? 90 : 0;
//	//}
//
//	(MinimizarParty == 1)? (moveparty = (*(DWORD*)0x81F6B6C > 0) ? 80 : 0):moveparty = (GetPartyBar.PartyMemberCount > 0) ? 90 : 0;
//
...
//		{
//			RenderBitmap(31310 , x - 22.0f , 27 , 16, 22, 0.0 , 0.0 , 0.07712502778 , 0.1080000103, 1, 1, 0.0);
//		}
//	}
//	else
//	{
...
//
//	pDrawText(pTextThis(), x, y + 5,  (LPCTSTR)nameIndex, 50, 0, (LPINT)3, 0);
//
//	v15 = (double)hp / (double)hpmax * 50.0;
//	v16 = (float)(y + 16);
//	SetDouble(0xD23AB8, QTFrame.DisplayWin); //-- Effect
//	sub_5B9260((float)x, v16, 50.0, 4.0, v15, 0, 1);
//	SetDouble(0xD23AB8, 640.0); //-- Effect
//
//	pGLSwitch();
//	glColor3f(1.0, 1.0, 1.0);
//}
...
void JCurrentExp(int ImageID, float PosX, float PosY, float Width, float Height, float CurrentMoveX, float CurrentMoveY, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, bool ScaleAlpha)
{
	...
	RenderBitmap(ImageID, JCResto + 60.0f, 474.0f, RenderW, 3.0f, CurrentMoveX, CurrentMoveY, ScaleX, ScaleY, ScaleSize, ScalePosition, ScaleAlpha);
}
...
void JCurrentMoveExp(int ImageID, float PosX, float PosY, float Width, float Height, float CurrentMoveX, float CurrentMoveY, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, bool ScaleAlpha)
{
	...
	RenderBitmap(ImageID, JCResto + JCCoordX, 474.0f, RenderW, 3.0f, CurrentMoveX, CurrentMoveY, ScaleX, ScaleY, ScaleSize, ScalePosition, ScaleAlpha);
}
...
void JCurrentAddExp(float PosX, float PosY, float Width, float Height, float Arg5, int Arg6)
{
	...
	pDrawBarForm(JCResto + JCCoordX, 474.0f, RenderW, 3.0f, Arg5, Arg6);
}
...
bool JCheckExpBarCurrent(int x, int y, int w, int h)
{
	...
	return pCheckMouseOver(JCResto + 60, 474, 518, 3);
}
...
int JTooltipExpCurrent(int X, int Y, LPCSTR Text)
{
	...
	return pDrawToolTip(JCResto + 220, Y, Text);
}
...
void JBarNumberExp(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumberEx(JCResto + 604.375, 470, Number, 0.90);
}
...
void JAttributoPlayer(int ImageID, float PosX, float PosY, float Width, float Height, float CurrentX, float CurrentY, float ScaleX, float ScaleY, bool ScaleSize, bool ScalePosition, float ScaleAlpha)
{
	...
	if( ImageID == 31296 || ImageID == 31297 || ImageID == 31298 ) //-- Current HP || mp
	{
		...
		{
			//-- mana
			RenderBitmap(51501, JCResto + 464.5f, 410.0f, 59.5f, 59.0f, 0.0, 0.0, 0.986000061f, 0.986000061f, 1, 1, 0.0); //-- Life

			v21 = v19 * (float)59.0f + (float)410.0; //-- nueva posición Y
			RenderBitmap(ImageID, JCResto + 464.5f, v21, 59.5f, v18, 0.0, v5, 0.986000061f, v3, 1, 1, 0.0); //-- Mana
		}
		else
		{
			//-- vida
			RenderBitmap(51502, JCResto + 107.5f, 409.5f, 62.0f, 59.0f, 0.0, 0.0, 0.986000061f, 0.986000061f, 1, 1, 0.0); //-- Life

			v21 = v19 * (float)59.0f + (float)409.5; //-- nueva posición Y
			RenderBitmap(ImageID, JCResto + 107.5f, v21, 62.0f, v18, 0.0, v5, 0.986000061f, v3, 1, 1, 0.0); //-- Life
		}
	}
	else //-- Current AG || SD
	{
		...
		if(ImageID == 31299)	//-- ag
		{
			...
			RenderBitmap(31299, JCResto + v21, 427.875f, v18, 9.375f, v5, 0.0, v3, 1.0, 1, 1, 0.0);
		}
		else	//-- sd
		{
			...
			RenderBitmap(31300, JCResto + 179.975, 427.875f, v18, 9.375f, 0.0, 0.0, v3, 1.0, 1, 1, 0.0);
		}
	}
}
...
bool JAttributoCheck(int a1, int a2, int a3, int a4)
{
	...
	if( a1 == 158 )
	{
		return pCheckMouseOver(JCResto + 108, 410, 62, 59); //-- HP
	}
	else if( a1 == 437 )
	{
		return pCheckMouseOver(JCResto + 465, 410, 59, 59); //-- MP
	}
	else if( a1 == 420 )
	{
		return pCheckMouseOver(JCResto + 395, 428, 70, 13);
	}
	else
	{
		return pCheckMouseOver(JCResto + 180, 428, 65, 13);
	}
}
...
int JAttributoTooltip(int a1, int a2, LPCSTR Text)
{
	...
	if( a1 == 158 )
	{
		return pDrawToolTip(JCResto + 108, 395, Text); //-- HP
	}
	else if( a1 == 437 )
	{
		return pDrawToolTip(JCResto + 465, 395, Text); //-- MP
	}
	else if(a1 == 400)
	{
		return pDrawToolTip(JCResto + 395, 415, Text);	//-- AG
	}
	else
	{
		return pDrawToolTip(JCResto + 180, 415, Text);	//-- SD
	}
}
...
void JExInterfaceLeft(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	RenderBitmap(31293, PosX + JCResto, v5, 640, 73, 0.0, 0.0, 0.9129598141, 0.8629598618, 1, 1, 0.0);
	...
	wsprintf(JCPrintText, pGetTextLine(pTextLineThis, 1181), ViewCurHP, ViewMaxHP);

	pDrawText(pTextThis(), JCResto + 107 - 5, 439, JCPrintText, 70, 0, (LPINT)3, 0);
	//--
	ZeroMemory(JCPrintText, sizeof(JCPrintText));
	wsprintf(JCPrintText, pGetTextLine(pTextLineThis, 1181), ViewCurMP, ViewMaxMP);

	pDrawText(pTextThis(), JCResto + 464, 439, JCPrintText, 70, 0, (LPINT)3, 0);
	//--
	ZeroMemory(JCPrintText, sizeof(JCPrintText));
	wsprintf(JCPrintText, pGetTextLine(pTextLineThis, 1181), ViewCurSD, ViewMaxSD);

	pDrawText(pTextThis(), JCResto + 180, 429, JCPrintText, 65, 0, (LPINT)3, 0);
	//--
	ZeroMemory(JCPrintText, sizeof(JCPrintText));
	wsprintf(JCPrintText, pGetTextLine(pTextLineThis, 1181), ViewCurBP, ViewMaxBP);

	pDrawText(pTextThis(), JCResto + 395, 429, JCPrintText, 70, 0, (LPINT)3, 0);
...
void JExInterfaceMiddle1(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	for( int k = 0; k < 6; k++ )
	{
		...
		if( pCheckMouseOver(x, y, 20.5, 20.5) )
		{
			pDrawToolTip(x, PosY + 10, pGetTextLine(pTextLineThis, tooltip));
		}

		if( JCEventButton(x, y, 20.5, 20.5) )
		{
			RenderBitmap(0x901, x, y, 20.5, 20.5, current2x, currenty, scalex, scaley, 1, 1, 0.0);
		...
		{
			RenderBitmap(0x901, x, y, 20.5, 20.5, (active == 1) ? current2x : current1x, currenty, scalex, scaley, 1, 1, 0.0);
		}
	}
}
...
void JExInterfaceRight(int ImageID, float PosX, float PosY, float Width, float Height)
{
	...
	ChangeButtonInfo((char *)(v38 +  56), JCResto + 43, PosY + 20, 20, 20); //-- cashshop
	ChangeButtonInfo((char *)(v38 + 228), JCResto + 68, PosY + 20, 20, 20); //-- character
	ChangeButtonInfo((char *)(v38 + 400), JCResto + 92, PosY + 20, 20, 20); //-- Inventory

	ChangeButtonInfo((char *)(v38 + 744), JCResto + 576, PosY + 20, 20, 20); //-- Menu Fast
	ChangeButtonInfo((char *)(v38 + 572), JCResto + 552, PosY + 20, 20, 20); //-- Friend List
}
...
{
	static DWORD Addr_JMP = 0x00895A73;
	static float RenderPotionY = 445.5f;
	static float RenderNumberY = 460.0f;
...
void JCCashShopLand( BYTE Mode )
{
	...
	{
		//-- boton buy
		ChangeButtonInfo((char *)(v4 + 172 * i + 168), *(DWORD *)(v4 + 36) + 122 * (i % 3) + 162, 121 * (i / 3) + 126, 52, 26);
	}
}
...
{
	RenderBitmap(ImageID,  PosX + QTFrame.DisplayWinCDepthBox, PosY, Width,  Height,  Arg6,  Arg7,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
}
...
{
	RenderBitmap(ImageID,  PosX, PosY, Width,  Height,  Arg6,  Arg7,  ScaleX,  ScaleY,  ScaleSize,  ScalePosition, ScaleAlpha);
}


void BtnSta(int ImageID, float PosX, float PosY, float Width, float Height)
{
	int v38; // [sp+14h] [bp-28h]@1
	...
	//ChangeButtonInfo((char *)(v38 + 228), JCResto + 519, 429, 30, 41); //-- btn Illus
	ChangeButtonInfo((char *)(v38 + 6),  PosX + JCResto, PosY, Width, Height); //-- btn Illus
}



void FixNumberTimeIllus(float a4, float a5, int Number, float a7)
{
	int JCResto = (int)pWinWidth / pWinHeightReal - 640;
...
void FixNumberTimeIllus2(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumber(a4 + JCResto + 65, a5, Number, a7);
}
...
void FixNumberIllus(float a4, float a5, int Number, float a7)
{
	...
	JCRenderNumberIllus(a4 + JCResto, a5, Number, a7);
}




void JCInterface::Load( )
{
	...
	//SetCompleteHook(0xE8, 0x0086D5C3, &BtnSta);//-text btn 0x7BC8u
	//SetCompleteHook(0xE8, 0x0086D5F4, &BtnSta);//-text btn 0x7BC9u
	//SetCompleteHook(0xE8, 0x0086D625, &BtnSta);//-text btn 0x7BBEu

	//----skill
	SetCompleteHook(0xE8, 0x0086E095, &FixNumberTimeIllus2);	// number point 
	SetCompleteHook(0xE8, 0x0086E10D, &FixNumberTimeIllus2);	// number point 
	SetCompleteHook(0xE8, 0x0086E01D,  &FixMiniMapIllus);	//0x7A4Du | 0x7A53u	"Interface\\newui_skill2.jpg" | "Interface\\newui_non_skill2.jpg" 
	
	//--NumberSkill
	//---hover text on mouse
	SetCompleteHook(0xE8,0x0086E3AD, &FixNumberIllus);
	SetCompleteHook(0xE8,0x0086E4D4, &FixNumberIllus);
	SetCompleteHook(0xE8,0x0086E5F9, &FixNumberIllus);
	...
	//----timeDown
	SetCompleteHook(0xE8, 0x0086E79F, &FixNumberTimeIllus);  // dau :
	SetCompleteHook(0xE8, 0x0086E830, &FixNumberTimeIllus);	 // Time
	SetCompleteHook(0xE8, 0x0086E861, &FixNumberTimeIllus);	 // Time
	SetCompleteHook(0xE8, 0x0086E8D2, &FixNumberTimeIllus);	 // Time
	SetCompleteHook(0xE8, 0x0086E903, &FixNumberTimeIllus);	 // Time
	...
	case JSeason2:
		...
		gCChatClassic.Load( );
		SetCompleteHook(0xE9, 0x007DFA60, &PetHPBarRemake);

		SetCompleteHook(0xE9, 0x00812120, &sub_812120); //InterfaceGeneral
		...
		SetCompleteHook(0xE9, 0x00895B8D, &RenderSlotDwongradeR);
		//--
		SetCompleteHook(0xE8, 0x0080FF28, &JInfoAtributoHP);	//-- hp
		SetCompleteHook(0xE8, 0x008100BB, &JInfoAtributoMP);	//-- mp
		SetCompleteHook(0xE8, 0x00810389, &JInfoAtributoAG);	//-- aG
		SetCompleteHook(0xE8, 0x00810659, &JInfoAtributoSD);	//-- sd
		//-- Print attributo
		SetCompleteHook(0xE8, 0x0080FEEF, &JPrintAtributoPlayer); //-- hp
		SetCompleteHook(0xE8, 0x0080FE56, &JPrintAtributoPlayer); //-- hp venom
		SetCompleteHook(0xE8, 0x00810083, &JPrintAtributoPlayer); //-- mana
		SetCompleteHook(0xE8, 0x00810354, &JPrintAtributoPlayer); //-- AG
		SetCompleteHook(0xE8, 0x00810624, &JPrintAtributoPlayer); //-- SD
		//-- check atributos
		SetCompleteHook(0xE8, 0x0080FF56, &JCheckAtributoPlayer); //-- hp
		SetCompleteHook(0xE8, 0x008100E9, &JCheckAtributoPlayer); //-- mp
		SetCompleteHook(0xE8, 0x008103B7, &JCheckAtributoPlayer); //-- AG
		SetCompleteHook(0xE8, 0x00810699, &JCheckAtributoPlayer); //-- SD
		//-- Tooltip Attributos
		SetCompleteHook(0xE8, 0x0080FFA7, &JInfoAtributoPlayer); //-- HP
		SetCompleteHook(0xE8, 0x0081013A, &JInfoAtributoPlayer); //-- MP
		SetCompleteHook(0xE8, 0x00810408, &JInfoAtributoPlayer); //-- AG
		SetCompleteHook(0xE8, 0x008106EA, &JInfoAtributoPlayer); //-- SD
		//--
		SetCompleteHook(0xE8, 0x0080F2E8, &InterfaceButton);
		SetCompleteHook(0xE8, 0x0080F3D3, &InterfaceButton);
		SetCompleteHook(0xE8, 0x0080F4C7, &InterfaceButton);
		SetCompleteHook(0xE8, 0x0080F5BB, &InterfaceButton);
		SetCompleteHook(0xE8, 0x0080F6AF, &InterfaceButton);
		//--
		SetCompleteHook(0xE8, 0x0080F92D, &JInterfaceLeft); //-- Letter Print
		SetCompleteHook(0xE8, 0x0080F968, &JInterfaceMiddle); //-- Letter Print
		SetCompleteHook(0xE8, 0x0080F9A3, &JInterfaceRight); //-- Letter Print
		SetCompleteHook(0xE8, 0x0080FA02, &JInterfaceMiddle); //-- Letter Print
		//--
		SetCompleteHook(0xE8, 0x00810F45, &RenderNumberExp);
		SetCompleteHook(0xE8, 0x008117EE, &RenderNumberExp);
		//--
		SetCompleteHook(0xE8, 0x00810FE7, &JCTooltipExpCurrent);
		SetCompleteHook(0xE8, 0x00811890, &JCTooltipExpCurrent);
		//--
		SetCompleteHook(0xE8, 0x00810F97, &pCheckExpBarCurrent);
		SetCompleteHook(0xE8, 0x00811840, &pCheckExpBarCurrent);
		//--
		// master experiencia
		SetCompleteHook(0xE8, 0x00810A1A, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00810BE5, &JCMoveExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00810D2C, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00810DC3, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00810EF0, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00810A97, &JCExpBarDowngradeAdd);
		SetCompleteHook(0xE8, 0x00810C62, &JCExpBarDowngradeAdd);
		SetCompleteHook(0xE8, 0x00810E40, &JCExpBarDowngradeAdd);
		//-- normal experiencia
		SetCompleteHook(0xE8, 0x008112A6, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x0081147F, &JCMoveExpBarDowngrade);
		SetCompleteHook(0xE8, 0x008115C9, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00811660, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00811790, &JCExpBarDowngrade);
		SetCompleteHook(0xE8, 0x00811323, &JCExpBarDowngradeAdd);
		SetCompleteHook(0xE8, 0x008114FC, &JCExpBarDowngradeAdd);
		SetCompleteHook(0xE8, 0x008116DD, &JCExpBarDowngradeAdd);
		InitInter3();
		break;
	case JLegends:
	case JEx700:
