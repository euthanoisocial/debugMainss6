...
{
#if(CUSTOM_FLAGS)
	LoadItemModel(7780, "Item\\", "Flag100",-1);
#endif
	((void(*)())0x00617D30)();
...
//tue add flag
	...
	{
		LoadItemModel(it->second.ModelIndex + ITEM_BASE_MODEL, "WZen\\Flag\\", it->second.ModelName, -1);
		pDrawMessage("it->second.ModelName: ", 1); // Thông báo debug
		pDrawMessage(it->second.ModelName , 1); // Thông báo debug
	}
#endif
//////////////
...
{
#if(CUSTOM_FLAGS)
	LoadItemTexture(7780, "Item\\", "Flag100",-1);
#endif
	((void(*)())0x0061AED0)();
//tue add flag 
#if(HT_THUE_FLAG)
	for (std::map<int, MODEL_FLAG>::iterator it = gCustomModelFlag.mModelFlagData.begin(); it != gCustomModelFlag.mModelFlagData.end(); it++)
	{
		LoadItemTexture(it->second.ModelIndex + ITEM_BASE_MODEL, "WZen\\Flag\\", it->second.ModelName, -1);
	}
#endif
//////////////////////
	for(int n=0;n < MAX_CUSTOM_JEWEL;n++)
