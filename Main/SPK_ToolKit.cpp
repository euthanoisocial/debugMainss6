...
void SPK_ToolKitMain::CloseButton(float X, float Y, int Enum)
{
	...
	if (gInterface.IsWorkZone(Enum))
	{
		...
		gInterface.DrawToolTip(gInterface.Data[Enum].X + 5, gInterface.Data[Enum].Y + 25, gConfig.TSPK_TEXT_ENGINE[26]);
	}
}
...
void SPK_ToolKitMain::DrawButtonIconRank(int Enum, int ImgID, float X, float Y, float W, float H, LPCSTR Text)
{
...
void SPK_ToolKitMain::CreateFontNew(int X, int Y, int W, int Pos, int Size, int Bold, LPCSTR String, COLORREF TextColor, HFONT CrateSub)
{
	...
	g_pRenderText2.CRenderText(X, Y, String, W, -1, Pos, 0);
...
void SPK_ToolKitMain::MakeShadowText(int X, int Y, int W, int Pos, LPCSTR String,...)
{
	...
	g_pRenderText2.CRenderText(X, Y, String, W, 0, Pos, 0);
}
...
void SPK_ToolKitMain::DrawButtonIcon( int Enum, int ImgID,float X, float Y, float W, float H, LPCSTR Text)
{
...
void SPK_ToolKitMain::DrawButtonIconMove( int Enum, int ImgID,float X, float Y, float W, float H)
{
