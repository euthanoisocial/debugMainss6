...
int nCInfo::nInformationOP(int CurrenLine, int ItemSearch)
{
	...
	if(it !=  GInfo.m_CustomInfo.end())
	{
		...
		for( int i = 0 ; i < 15 ; i++ )
		{
				if((((ItemSearch - (ItemSearch%512) ) /512) == 12)) //index 12 == wing
				{
					if( it->second.TextIndex[ i ] == -1) { continue; }
					
					if(gCuongHoaWing.cuonghoawing >= 1 && i == 1)
					{
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else if(gCuongHoaWing.cuonghoawing >= 2 && i == 2){
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else if(gCuongHoaWing.cuonghoawing >= 3 && i == 3){
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else if(gCuongHoaWing.cuonghoawing >= 4 && i == 4){
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else if(gCuongHoaWing.cuonghoawing >= 5 && i == 5){
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else{
					...
					else if((((ItemSearch - (ItemSearch%512) ) /512) == 0)) //VKR
				{
					if( it->second.TextIndex[ i ] == -1) { continue; }
					
					if(gVuKhiRong.vukhirong >= 1 && i == 1)
					{
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else if(gVuKhiRong.vukhirong >= 2 && i == 2){
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else if(gVuKhiRong.vukhirong >= 3 && i == 3){
						wsprintf(TooltipLine[ CurrenLine ], "%s", nGetTextLine( it->second.TextIndex[ i ] ));
						ColorTexto[ CurrenLine ] = it->second.TextColor[ i ]; 
					}
					else{
				...
				else if((((ItemSearch - (ItemSearch%512) ) /512) == 5)) //VKR
				{
					if( it->second.TextIndex[ i ] == -1) { continue; }
					...
					else if((((ItemSearch - (ItemSearch%512) ) /512) == 4)) //VKR
				{
					if( it->second.TextIndex[ i ] == -1) { continue; }
				...
				else if((((ItemSearch - (ItemSearch%512) ) /512) == 2)) //VKR
				{
					if( it->second.TextIndex[ i ] == -1) { continue; }
		            ...
		            wsprintf(TooltipLine[CurrenLine++], "\n");
		            wsprintf(TooltipLine[ CurrenLine ], "Dev By Solar™");
		            ColorTexto[ CurrenLine ] = 13;
		            LineWeight[ CurrenLine++ ] = 1;
