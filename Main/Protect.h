...
struct MAIN_FILE_INFO
{
	...
	DWORD Disableviptaikhoan;
	DWORD Disablevipnhanvat;
	DWORD Disabledanhhieu;
	DWORD Disablequanham;
	DWORD Disabletuluyen;
	DWORD Disablekinhmach;
	DWORD Disablenguhanh;
	DWORD Disablethuankhiet;
	DWORD Disablevongquay;
	//--ElfSoldier
	...
	DWORD CustomShowNhiemVu;
	DWORD MultiCharacter;
