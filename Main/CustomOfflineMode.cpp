...
void cOfflineMode::BinObeject()
{
#if(OFFLINE_MODE_NEW)
	gInterface.BindObject(eOFFEXP_MAIN, 31461, 900, 1000, -1, -1);  // 31461
	gInterface.BindObject(eOFFEXP_TITLE, 0x7A63, 230, 67, -1, -1);
	gInterface.BindObject(eOFFEXP_FRAME, 0x7A58, 230, 15, -1, -1);
	gInterface.BindObject(eOFFEXP_FOOTER, 0x7A59, 230, 50, -1, -1);
	gInterface.BindObject(eOFFEXP_DIV, 0x7A62, 223, 21, -1, -1);
	gInterface.BindObject(eOFFEXP_POINT, 0x7B68, 10, 10, -1, -1);
	gInterface.BindObject(eOFFEXP_CLOSE, 0x7EC5, 36, 29, -1, -1);
	gInterface.BindObject(eOFFEXP_CHECKBOX_BUFF, 0x7BAE, 15, 15, -1, -1);
	gInterface.BindObject(eOFFEXP_CHECKBOX_PICK_ZEN, 0x7BAE, 15, 15, -1, -1);
	gInterface.BindObject(eOFFEXP_CHECKBOX_PICK_JEWELS, 0x7BAE, 15, 15, -1, -1);
	gInterface.BindObject(eOFFEXP_CHECKBOX_PICK_EXC, 0x7BAE, 15, 15, -1, -1);
	gInterface.BindObject(eOFFEXP_CHECKBOX_PICK_ANC, 0x7BAE, 15, 15, -1, -1);
	gInterface.BindObject(eOFFEXP_CHECKBOX_SELECTED_HELPER, 0x7BAE, 15, 15, -1, -1);
	gInterface.BindObject(eOFFEXP_BTN_OK, 0x7A5E, 106, 29, -1, -1);
	gInterface.BindObject(eOFFEXP_SKILL1, 0x7A4C, 20, 28, -1, -1);
	gInterface.BindObject(eOFFEXP_SKILL2, 0x7A4C, 20, 28, -1, -1);
	gInterface.BindObject(eOFFEXP_SKILL3, 0x7A4C, 20, 28, -1, -1);
#endif
}
